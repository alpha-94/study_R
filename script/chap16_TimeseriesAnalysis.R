...
# 자기 상관함수/ 부분자기상관함수  
##################################
# 자기 상관 함수(Auto Correlation Function) 비례 :: 높으면 서로 상관이 있음 , 낮으면 서로 독립적
...
plot(SMA(tsdata, n=3), main="3년 단위 이동평균법으로 평활") # n 값이 높을수록 완만한 그래프 생성 
...
plot(tsdata, type="l", col='red') # 비정상성 파악 
...
arima
# ARIMA(1,1,0) 한번 차분한 결과가 정상성 시계열의 모형 AR(1) 모형으로 식별 
